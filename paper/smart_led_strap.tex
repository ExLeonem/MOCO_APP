...
different devices, it is fairly easy to implement one such device accompanyed by an application oneself using todays technologies
...
Finally leading to an outlook to further functionality.
...
% lack of security: issues not the lack of specification because most devices have spec. standard encryption system
